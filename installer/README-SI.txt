DineMate POS — Install කරන විදිහ
=====================================

✅ ප්‍රධාන විදිහ: "DineMate POS Setup 1.1.4.exe" double-click කරන්න.
...
2. "DineMate POS Setup 1.1.4.exe" run කරන්න (හෝ DineMate-POS-Setup-v1.1.4.zip extract කරන්න)
3. VERSION.txt බලන්න — version 1.1.4 වෙන්න ඕනේ
4. Install wizard complete කරන්න
5. Desktop එකේ "DineMate POS" shortcut open කරන්න
6. Login කරන්න
...
සටහන:
- Internet ඕනේ (server: 136.65.34.15)
